                ...
                <div className="row my-5">
                    ...
                    <div className="col-md-4">
                        <div className="card px-3 py-4">
                            <form>
                                <input name='name' placeholder='Full Name' value={userData.name} className='form-control mt-3' type="text" />
                                <input name='number' placeholder='Phone No.' className='form-control mt-3' type="text" />
                                <input name='email' placeholder='Username or Email' value={userData.email} className='form-control mt-3' type="email" />
