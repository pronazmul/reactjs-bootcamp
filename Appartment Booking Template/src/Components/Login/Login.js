...
const Login = (props) => {
    ...
    // console.log(props.data.isSignIn)
                    ...
                    <div className="card p-5">
                                ...
                                <>
                                    ...
                                    <form className="" onSubmit={handleSubmit(onSubmit)}>
                                        ...
                                        <div className="d-flex login-alert">
                                            ...
                                            <div>
                                                <Link href="#" className="green-text">Forget Password</Link>
                                            </div>
                                        </div>
                        ...
                        <div className="social-login text-center">
                            ...
                            <div className="google-signIn">
                                <Link onClick={googleLogin} className="btn btn-block pt-2 pb-0">
                            ...
                            <div className="fb-signIn mt-2">
                                <Link onClick={facebookLogin} className="btn btn-block pt-2 pb-0">
